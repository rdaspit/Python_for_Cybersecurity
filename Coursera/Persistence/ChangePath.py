# Python for Cybersecurity - Infosec Skills on Coursera
# Redirect path to a malicious path
...
def editPathValue(reghive,regpath,targetdir):
    ...
    reg = winreg.ConnectRegistry(None,reghive) # "None" specifies the local registry instead of remote
